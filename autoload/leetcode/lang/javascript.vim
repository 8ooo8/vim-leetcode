...
let s:ext = 'js'
let s:dependencies = []
let s:depend_location = '' 
let s:code_begin_location = ''
...
fu! leetcode#lang#javascript#getCustomDependencies()
  ...
  let [comment_first_line, comment_last_line] = leetcode#lang#javascript#locateLeetcodeCliComment(lc_code_start_line + 1)
...
fu! leetcode#lang#javascript#addDependencies()
  ...
  let custom_depend = leetcode#lang#javascript#getCustomDependencies()
